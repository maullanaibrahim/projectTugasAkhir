                        ...
                        <div class="card top-selling overflow-auto">
                            <div class="card-body pb-0">
                                ...
                                <form class="row g-3 mb-3" action="/divisions/{{ $division->id }}" method="POST">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-floating">
                                            <input type="text" class="form-control text-uppercase @error('division_name') is-invalid @enderror" name="division_name" id="namaDivisi" placeholder="Nama Divisi" value="{{ old('division_name', $division->division_name) }}" required>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-floating">
                                            <textarea class="form-control text-uppercase @error('address') is-invalid @enderror" name="address" id="alamat" placeholder="Alamat" style="height: 100px;">{{ old('address', $division->address) }} </textarea>
